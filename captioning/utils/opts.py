...
def parse_opt():
    ...
    parser.add_argument('--input_att_dir_iod', type=str, default='data/IOD',
    ...
    parser.add_argument('--glove_embedding_dict', type=str, default='data/Glove_embedding.npy',
                        help='path to the glove_embedding')
    parser.add_argument('--visual_dict', type=str,
                        default='data/vis.npy',
                        help='path to the visual dict')
    parser.add_argument('--lin_dict', type=str,
                        default='data/dict2.npy',
    ...
    parser.add_argument('--iod_feat_size', type=int, default=1024,
                        help='iod')
    ...
    parser.add_argument('--label_smoothing', type=float, default=0.0,
                    help='')
    parser.add_argument('--noamopt', action='store_true', default=True,
                    help='')
    ...
    # misc
    parser.add_argument('--id', type=str, default='exp',
