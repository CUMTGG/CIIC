...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default=r'E:\self-critical.pytorch-master\data\dataset_coco.json', help='input json file to process into hdf5')
    parser.add_argument('--dict_json', default=r'E:\self-critical.pytorch-master\data\cocotalk.json', help='output json file')
    parser.add_argument('--output_pkl', default=r'E:\self-critical.pytorch-master\data\coco-train', help='output pickle file')
